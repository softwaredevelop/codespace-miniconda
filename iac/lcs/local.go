...
func main() {
	...
	// Main project
	createAndDeployStack(ctx, "trade", "dev-codespace-miniconda", "localproject_main", auto.ConfigMap{
	...
	// Mirrored project
	createAndDeployStack(ctx, "gitlab-mirror", "dev-codespace-miniconda-mirrored", "localproject_mirrored", auto.ConfigMap{
